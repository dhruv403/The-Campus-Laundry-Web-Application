  ...
  return (
    ...
    <div className="head">
      <div className="sec">
        ...
        {/* <div className="sec2">
          {items.map((item) => (
            <div key={item._id} className="item mx-4">
              <div className="s-1">{item.name}</div>
              <div className="s-2">
                <Counter
                  count={itemQuantities[item.name]}
        ...
        <div className="sec3">
          <button type="button" onClick={handleOrder} className="btn btn-checkout">
            Proceed To Checkout
          </button>
        </div>
      </div>
